define([
    ...
    defineProperties(MyWidgetsViewModel.prototype, {
        /**
         * Gets the scene to control.
         * @memberof MyWidgetsViewModel.prototype
         *
         * @type {Scene}
         */
        scene : {
     ...
     * @private
     */
    MyWidgetsViewModel.prototype._update = function() {
        if (this.frustums) {
     ...
     */
    MyWidgetsViewModel.prototype.isDestroyed = function() {
        return false;
    };
     ...
     */
    MyWidgetsViewModel.prototype.destroy = function() {
