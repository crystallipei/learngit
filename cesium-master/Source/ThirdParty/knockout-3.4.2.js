...
(function() {
    (function(n) {
        ...
        (function(n) {
            ...
            a.a = function() {
                ...
                return {
                    gc : ["authenticity_token", /^__RequestVerificationToken(_.*)?$/], r : function(a, b) {
                        ...
                        for (var d =
                            0, e = a.length; d < e; d++) if (b.call(c, a[d], d)) {
                            return a[d];
                        }
                        return null
                    }, Na : function(b, c) {
                    ...
                    yd : 7 === k, C : k, ic : function(b, c) {
                        ...
                        if ("object" == typeof c && "form" === a.a.A(c)) {
                            for (var f = c.action, l = m.length - 1; 0 <= l; l--) for (var g = a.a.ic(c, m[l]), h = g.length - 1; 0 <= h; h--) k[g[h].name] = g[h].value;
                        }
                        d = a.a.c(d);
            ...
            a.h = function() {
                ...
                return {
                    va : [], ga : h, Ab : b, Xa : function(e, m) {
                        ...
                        for (var c = 0; c < a.length; c++) if (a[c].key == b) {
                            return !0;
                        }
                        return !1
            ...
            a.P.prototype.isTemplateRewritten = function(
                a,
                c) {
